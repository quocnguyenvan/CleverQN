...
//        
//        // 2
//        frame = CGRect(x: frame.origin.x - blueRectangleLayer.lineWidth, y:
//            frame.origin.y - blueRectangleLayer.lineWidth, width:
//            frame.size.width + blueRectangleLayer.lineWidth * 2, height:
